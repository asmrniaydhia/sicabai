                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mb-2">
                                    @if ($bengkel->foto_bengkel)
                                        <img src="{{ asset('storage/' . $bengkel->foto_bengkel) }}" alt="Foto Bengkel" class="img-fluid rounded" style="height: 200px; object-fit: cover; border-radius: 10px;">
                                    @else
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control rounded-end-3" name="nama" value="{{ $bengkel->nama }}" readonly>
                                </div>
                            </div>
                            <!-- WhatsApp -->
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="tel" class="form-control rounded-end-3" name="whatsapp" value="{{ $bengkel->whatsapp }}" readonly pattern="[0-9+]*">
                                </div>
                            </div>
                            <!-- Alamat -->
                            <div class="mb-4">
                                <label class="text-dark mb-2 d-block fw-medium"><i class="fas fa-map-marker-alt me-2" style="color: #d9534f;"></i>Alamat</label>
                                <textarea class="form-control rounded-3" name="alamat" rows="4" readonly>{{ $bengkel->alamat }}</textarea>
                            </div>
                        </div>
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <div class="input-group">
                                            ...
                                            <input type="time" class="form-control rounded-end-3" name="jam_buka" id="jam_buka" value="{{ substr($bengkel->jam_buka, 0, 5) }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-group">
                                            <span class="input-group-text rounded-start-3" style="background-color: #f8f9fa;"><i class="fas fa-clock text-muted"></i></span>
                                            <input type="time" class="form-control rounded-end-3" name="jam_tutup" id="jam_tutup" value="{{ substr($bengkel->jam_tutup, 0, 5) }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    @foreach (['Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu', 'Minggu'] as $hari)
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label badge {{ in_array($hari, $bengkel->hari_libur ?? []) ? 'bg-danger' : 'bg-light text-muted' }} rounded-pill px-3 py-2" for="{{ $hari }}">{{ $hari }}</label>
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                                ...
                                <div class="row g-2 mt-3">
                                    <div class="col-4">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control rounded-end-3" name="lat" id="lat" value="{{ $bengkel->latitude }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="input-group">
                                            <span class="input-group-text rounded-start-3" style="background-color: #f8f9fa;"><i class="fas fa-map-marker-alt text-muted"></i></span>
                                            <input type="text" class="form-control rounded-end-3" name="lng" id="lng" value="{{ $bengkel->longitude }}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-4">
...
<script>
    $(document).ready(function() {
        ...
        var map = L.map('map-canvas').setView([{{ $bengkel->latitude ?? -3.320611 }}, {{ $bengkel->longitude ?? 114.591866 }}], 15);

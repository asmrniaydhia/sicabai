...
<div class="container-fluid">
    ...
    {{-- <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Beranda Bengkel Tambal Ban</h1>
    </div> --}}
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body p-5">
                        <form id="bengkelForm" class="user" method="POST" action="{{ $bengkelTambalBan->jenis_bengkel === 'tambal_ban' ? route('tambalBan.update', $bengkelTambalBan->id) : route('bengkelService.update', $bengkelTambalBan->id) }}" enctype="multipart/form-data">                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        @if ($bengkelTambalBan->foto_bengkel)
                                            <img src="{{ asset('storage/' . $bengkelTambalBan->foto_bengkel) }}" alt="Foto Bengkel" class="img-fluid rounded" style="max-height: 150px; object-fit: cover;">
                                        @else
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control rounded-pill" name="nama" value="{{ $bengkelTambalBan->nama }}" readonly>
                                    </div>
                                    <div class="mb-4">
                                        <label class="text-gray-700 mb-2 d-block">
                                            <i class="fab fa-whatsapp mr-2"></i> WhatsApp
                                        </label>
                                        <input type="tel" class="form-control rounded-pill" name="whatsapp" value="{{ $bengkelTambalBan->whatsapp }}" readonly>
                                    </div>
                                    <div class="mb-4">
                                        <label class="text-gray-700 mb-2 d-block">
                                            <i class="fas fa-map-marker-alt mr-2"></i> Alamat
                                        </label>
                                        <textarea class="form-control rounded" name="alamat" rows="4" readonly>{{ $bengkelTambalBan->alamat }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="time" class="form-control rounded-pill" name="jam_buka" id="jam_buka" value="{{ substr($bengkelTambalBan->jam_buka, 0, 5) }}" readonly>
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="time" class="form-control rounded-pill" name="jam_tutup" id="jam_tutup" value="{{ substr($bengkelTambalBan->jam_tutup, 0, 5) }}" readonly>                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="text-gray-700 mb-2 d-block">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="text" class="form-control rounded-pill" name="lat" id="lat" value="{{ $bengkelTambalBan->latitude }}" readonly>
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control rounded-pill" name="lng" id="lng" value="{{ $bengkelTambalBan->longitude }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        var map = L.map('map-canvas').setView([{{ $bengkelTambalBan->latitude ?? -3.320611 }}, {{ $bengkelTambalBan->longitude ?? 114.591866 }}], 13);

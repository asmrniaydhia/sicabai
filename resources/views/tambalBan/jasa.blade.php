...
@section('content')
        ...
        <div class="form-container">
            ...
            <form id="sparepartForm" action="{{ route('admin.sparepart') }}" method="POST">
                ...
                <div class="form-group">
                    <label for="nama_sparepart" class="form-label">🛠️ Nama Jasa Service</label>
                    <input type="text" id="nama_sparepart" name="nama_sparepart"
                        class="form-input @error('nama_sparepart') is-invalid @enderror"
                        placeholder="Masukkan nama jasa service (contoh: Service Rutin, Ganti Oli, dll)..." required
                ...
                {{-- <div class="form-group">
                    <label for="deskripsi" class="form-label">💰 Harga Service</label>
                    <textarea id="deskripsi" name="deskripsi"
                        class="form-input form-textarea @error('deskripsi') is-invalid @enderror"
                        placeholder="Masukkan harga service dan deskripsi detail layanan (contoh: Rp 50.000 - Termasuk penggantian oli dan filter)..."
                ...
                <div class="mb-3 text-left">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control @error('harga_jual') is-invalid @enderror" id="harga_jual"
                            name="harga_jual" value="{{ old('harga_jual') }}" placeholder="0" min="0" step="0.01" required>
                        @error('harga_jual')
                    ...
                    <div class="sparepart-item">
                        <div class="item-content">
                            ...
                            <div class="item-actions">
                                <a href="{{ route('sparepart.edit', $sparepart->id) }}" class="btn btn-warning btn-small">✏️
                                    Edit</a>
    ...
    <script>
        ...
        document.getElementById('sparepartForm').addEventListener('submit', function (e) {
            ...
            if (namaSparepart === '') {
                alert('Nama jasa service harus diisi!');
                e.preventDefault();
                return;
            }

            if (deskripsi === '') {
                alert('Harga dan deskripsi service harus diisi!');
                e.preventDefault();
                return;
            }

            // Show confirmation
            if (!confirm('Apakah Anda yakin ingin menyimpan jasa service ini?')) {
                e.preventDefault();
            }
        });
